...
<body class="about-us">
    ...
    <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3  navbar-transparent ">
        <div class="container">
            <a class="navbar-brand  text-white " href="#" rel="tooltip" title="Codage" data-placement="bottom">
                Codage
            </a>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center mx-auto my-auto">
                        <h1 class="text-white">Codage Indonesia</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 m-auto">
                    ...
                    <p class="mb-4">
                        You want to get information about Codage. Please enter your email and click the subscribe button. Thank you 🙏🏼
                    </p>
                    <div class="row">
                        <div class="col-8">
        ...
        <div class="container">
            <div class=" row">
                <div class="col-md-3 mb-4 ms-auto">
                    <div>
                        <h6 class="text-gradient text-primary font-weight-bolder">Codage</h6>
                    </div>
                    <div>
                ...
                <div class="col-12">
                    <div class="text-center">
                        <p class="my-4 text-sm">
                            ...
                            </script> Codage Design by <a href="/" target="_self">Aurora Fice</a>.
                        </p>
                    </div>
                </div>
            </div>
